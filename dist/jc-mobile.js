...
function RefHeader({ view, setView }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "44px 60px 1fr 44px", alignItems: "center", gap: 12, padding: "18px 12px 20px" } }, /* @__PURE__ */ React.createElement("button", { style: { background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "menu", size: 31 })), /* @__PURE__ */ React.createElement("div", { style: { width: 54, height: 54, borderRadius: 16, display: "grid", placeItems: "center", background: "linear-gradient(135deg,#6F91FF,#2867EC)", color: "#fff", fontSize: 28, fontWeight: 700, boxShadow: "0 14px 30px rgba(36,103,236,.36)" } }, "M"), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18.5, fontWeight: 750, color: REF_TEXT, letterSpacing: "-.03em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, "Medique \xB7 JC Medical"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: REF_MUTED, marginTop: 3 } }, "Panel m\xF3vil")), /* @__PURE__ */ React.createElement("button", { style: { position: "relative", background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "bell", size: 29 }), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 1, right: 0, width: 22, height: 22, borderRadius: "50%", display: "grid", placeItems: "center", background: REF_BLUE, color: "#fff", fontSize: 12, fontWeight: 800, boxShadow: "0 7px 16px rgba(47,123,255,.45)" } }, "3")));
}
...
function MobileAdmin() {
  ...
  if (previewOnly) return /* @__PURE__ */ React.createElement(MobileShell, { T, D, onLogout: () => {
  } });
