...
const REF_APPTS = [
  { time: "10:30", name: "Christian Mart\xEDnez Mu\xF1oz", proc: "Evaluaci\xF3n general", dur: "30 min", status: "confirmada" },
  { time: "11:00", name: "Karen Sof\xEDa Baeza Arellano", proc: "Quemadores de grasa localizada", dur: "45 min", status: "confirmada" },
  { time: "11:45", name: "Mabel Baeza Arellano", proc: "Quemadores de grasa localizada", dur: "45 min", status: "pendiente" },
  { time: "12:30", name: "Rub\xE9n Albornoz Roco", proc: "Botox 3 zonas", dur: "30 min", status: "no_asistio" },
  { time: "13:00", name: "Emilia Buch\xF3n Vergara", proc: "Quemadores de grasa localizada", dur: "60 min", status: "confirmada" },
...
function RefIcon({ type, size = 24 }) {
  ...
  if (type === "menu") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M4 7h16M4 12h16M4 17h16" }));
  if (type === "bell") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M18 8a6 6 0 0 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" }), /* @__PURE__ */ React.createElement("path", { d: "M13.7 21a2 2 0 0 1-3.4 0" }));
  if (type === "calendar") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("rect", { x: "3", y: "4", width: "18", height: "17", rx: "3" }), /* @__PURE__ */ React.createElement("path", { d: "M8 2v4M16 2v4M3 10h18" }));
  if (type === "check") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("rect", { x: "5", y: "4", width: "14", height: "16", rx: "3" }), /* @__PURE__ */ React.createElement("path", { d: "m8.8 12.2 2.1 2.1 4.3-4.6" }));
  if (type === "clock") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "9" }), /* @__PURE__ */ React.createElement("path", { d: "M12 7v5l3 2" }));
  if (type === "bars") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M5 20V10M10 20V5M15 20v-8M20 20V8" }));
  if (type === "plus") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M12 5v14M5 12h14" }));
  if (type === "users") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" }), /* @__PURE__ */ React.createElement("circle", { cx: "9", cy: "7", r: "4" }), /* @__PURE__ */ React.createElement("path", { d: "M22 21v-2a4 4 0 0 0-3-3.7M16 3.3a4 4 0 0 1 0 7.4" }));
  if (type === "more") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("circle", { cx: "5", cy: "12", r: "1.4", fill: "currentColor", stroke: "none" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "12", r: "1.4", fill: "currentColor", stroke: "none" }), /* @__PURE__ */ React.createElement("circle", { cx: "19", cy: "12", r: "1.4", fill: "currentColor", stroke: "none" }));
  if (type === "filter") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M4 7h16M7 12h10M10 17h4" }), /* @__PURE__ */ React.createElement("circle", { cx: "8", cy: "7", r: "1.8" }), /* @__PURE__ */ React.createElement("circle", { cx: "16", cy: "12", r: "1.8" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "17", r: "1.8" }));
  if (type === "search") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("circle", { cx: "11", cy: "11", r: "7" }), /* @__PURE__ */ React.createElement("path", { d: "m20 20-3.5-3.5" }));
  if (type === "user") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "8", r: "4" }), /* @__PURE__ */ React.createElement("path", { d: "M4 21a8 8 0 0 1 16 0" }));
  if (type === "chev") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "m9 18 6-6-6-6" }));
  if (type === "back") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "m15 18-6-6 6-6" }));
  if (type === "x") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M18 6 6 18M6 6l12 12" }));
  if (type === "flame") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M12 22c4 0 7-2.8 7-6.8 0-3.4-2.4-5.7-4.2-7.6-.9-.9-1.7-1.9-2-3.1-.1-.5-.7-.7-1.1-.3C9.4 6.2 8 8.3 8 11c-1.3-.5-2.1-1.6-2.5-2.5-.2-.4-.8-.4-1 0A9.2 9.2 0 0 0 3 15.2C3 19.2 6.3 22 12 22Z" }), /* @__PURE__ */ React.createElement("path", { d: "M12 18c1.6 0 2.8-1.1 2.8-2.6 0-1.3-.9-2.1-1.6-2.9-.4-.4-.7-.7-.8-1.2-1 .8-1.7 1.8-1.7 3-.6-.3-1-.7-1.2-1.1-.4.7-.6 1.4-.6 2.2 0 1.5 1.3 2.6 3.1 2.6Z" }));
  if (type === "hourglass") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M6 2h12M6 22h12M7 2c0 5 5 6 5 10s-5 5-5 10M17 2c0 5-5 6-5 10s5 5 5 10" }));
  if (type === "note") return /* @__PURE__ */ React.createElement("svg", { ...common }, /* @__PURE__ */ React.createElement("path", { d: "M8 3h7l4 4v14H8a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3Z" }), /* @__PURE__ */ React.createElement("path", { d: "M14 3v5h5M9 13h6M9 17h4" }));
  return null;
}
function RefGlass({ children, style, onClick, as = "div" }) {
  const Comp = onClick ? "button" : as;
  return /* @__PURE__ */ React.createElement(Comp, { onClick, style: { position: "relative", overflow: "hidden", background: "linear-gradient(180deg, rgba(255,255,255,.13), rgba(255,255,255,.045) 38%, rgba(255,255,255,.015)), rgba(27,61,106,.32)", backdropFilter: "blur(30px) saturate(1.8) brightness(1.06)", WebkitBackdropFilter: "blur(30px) saturate(1.8) brightness(1.06)", border: "1px solid rgba(255,255,255,.18)", boxShadow: "0 18px 60px rgba(0,0,0,.28), inset 0 1px 0 rgba(255,255,255,.18)", color: REF_TEXT, fontFamily: SF, textAlign: "left", padding: 0, ...style } }, /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", inset: 0, pointerEvents: "none", background: "linear-gradient(180deg, rgba(255,255,255,.13), rgba(255,255,255,.035) 34%, transparent 70%)" } }), /* @__PURE__ */ React.createElement("span", { style: { position: "relative", zIndex: 1, display: "block" } }, children));
}
function RefStatusBadge({ status }) {
  const map = {
    ...
    no_asistio: { label: "NO ASISTI\xD3", color: "#FFC6C8", bg: "rgba(151,55,70,.62)", border: "rgba(255,115,129,.34)" }
  };
  const s = map[status] || map.confirmada;
  return /* @__PURE__ */ React.createElement("span", { style: { flexShrink: 0, padding: "8px 11px", minWidth: 92, textAlign: "center", borderRadius: 8, background: s.bg, border: "1px solid " + s.border, color: s.color, fontSize: 11, fontWeight: 700, letterSpacing: "-.01em" } }, s.label);
}
...
function RefStatusBar() {
  const item = (color, text) => /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 8, whiteSpace: "nowrap" } }, /* @__PURE__ */ React.createElement("i", { style: { width: 10, height: 10, borderRadius: "50%", background: color, boxShadow: "0 0 12px " + color } }), text);
  return /* @__PURE__ */ React.createElement(RefGlass, { style: { borderRadius: 15, padding: "12px 14px", fontSize: 14, color: REF_TEXT } }, /* @__PURE__ */ React.createElement("span", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, whiteSpace: "nowrap" } }, item("#57D887", "Hoy: 6 confirmadas"), item("#FFC23D", "1 pendiente"), item("#FF5167", "1 no asisti\xF3")));
}
function RefTopStatus() {
  return /* @__PURE__ */ React.createElement("div", { style: { height: 30, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 30px", color: "#fff", fontSize: 18, fontWeight: 500, textShadow: "0 1px 14px rgba(0,0,0,.3)" } }, /* @__PURE__ */ React.createElement("span", null, "9:41"), /* @__PURE__ */ React.createElement("div", { style: { width: 116, height: 34, borderRadius: 22, background: "#030509", boxShadow: "inset 0 1px 3px rgba(255,255,255,.08)" } }), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("svg", { width: "22", height: "14", viewBox: "0 0 24 14", fill: "currentColor" }, /* @__PURE__ */ React.createElement("rect", { x: "1", y: "8", width: "3", height: "5", rx: "1" }), /* @__PURE__ */ React.createElement("rect", { x: "6", y: "6", width: "3", height: "7", rx: "1" }), /* @__PURE__ */ React.createElement("rect", { x: "11", y: "3", width: "3", height: "10", rx: "1" }), /* @__PURE__ */ React.createElement("rect", { x: "16", y: "1", width: "3", height: "12", rx: "1" })), /* @__PURE__ */ React.createElement("svg", { width: "18", height: "14", viewBox: "0 0 24 16", fill: "none", stroke: "currentColor", strokeWidth: "2" }, /* @__PURE__ */ React.createElement("path", { d: "M2 5c5.8-4 14.2-4 20 0M6 9c3.5-2.3 8.5-2.3 12 0M10 13c1.2-.8 2.8-.8 4 0" })), /* @__PURE__ */ React.createElement("svg", { width: "25", height: "13", viewBox: "0 0 28 14", fill: "none", stroke: "currentColor", strokeWidth: "1.7" }, /* @__PURE__ */ React.createElement("rect", { x: "1", y: "2", width: "23", height: "10", rx: "2" }), /* @__PURE__ */ React.createElement("path", { d: "M26 5v4" }), /* @__PURE__ */ React.createElement("rect", { x: "3.5", y: "4.2", width: "18", height: "5.6", rx: "1", fill: "currentColor", stroke: "none" }))));
}
function RefHeader({ view, setView }) {
  if (view === "new") {
    return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "44px 1fr 44px", alignItems: "center", padding: "18px 12px 22px" } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setView("home"), style: { background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "back", size: 31 })), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", fontSize: 26, fontWeight: 700, color: REF_TEXT } }, "Nueva cita"), /* @__PURE__ */ React.createElement("button", { onClick: () => setView("home"), style: { background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "x", size: 31 })));
  }
  if (view === "agenda") {
    return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "44px 1fr 44px", alignItems: "center", padding: "18px 12px 20px" } }, /* @__PURE__ */ React.createElement("button", { style: { background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "menu", size: 31 })), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", fontSize: 27, fontWeight: 750, color: REF_TEXT } }, "Agenda"), /* @__PURE__ */ React.createElement("button", { style: { background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "filter", size: 27 })));
  }
  return /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "44px 60px 1fr 44px", alignItems: "center", gap: 12, padding: "18px 12px 20px" } }, /* @__PURE__ */ React.createElement("button", { style: { background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "menu", size: 31 })), /* @__PURE__ */ React.createElement("div", { style: { width: 54, height: 54, borderRadius: 16, display: "grid", placeItems: "center", background: "linear-gradient(135deg,#6F91FF,#2867EC)", color: "#fff", fontSize: 28, fontWeight: 700, boxShadow: "0 14px 30px rgba(36,103,236,.36)" } }, "M"), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 19, fontWeight: 750, color: REF_TEXT, letterSpacing: "-.03em" } }, "Medique \xB7 JC Medical"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: REF_MUTED, marginTop: 3 } }, "Panel m\xF3vil")), /* @__PURE__ */ React.createElement("button", { style: { position: "relative", background: "none", border: 0, color: REF_TEXT, height: 44 } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "bell", size: 29 }), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", top: 1, right: 0, width: 22, height: 22, borderRadius: "50%", display: "grid", placeItems: "center", background: REF_BLUE, color: "#fff", fontSize: 12, fontWeight: 800, boxShadow: "0 7px 16px rgba(47,123,255,.45)" } }, "3")));
}
function RefAppointmentRow({ a, compact = false }) {
  const color = RefStatusColor(a.status);
  return /* @__PURE__ */ React.createElement(RefGlass, { style: { borderRadius: 13, minHeight: compact ? 66 : 68 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "grid", gridTemplateColumns: "80px 1fr auto", alignItems: "center", minHeight: compact ? 66 : 68 } }, /* @__PURE__ */ React.createElement("span", { style: { height: "100%", display: "grid", placeItems: "center", borderLeft: "4px solid " + color, borderRight: "1px solid rgba(255,255,255,.14)", color, fontSize: 17, fontWeight: 700 } }, a.time), /* @__PURE__ */ React.createElement("span", { style: { minWidth: 0, padding: "0 15px" } }, /* @__PURE__ */ React.createElement("strong", { style: { display: "block", color: REF_TEXT, fontSize: 17, lineHeight: 1.15, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name), /* @__PURE__ */ React.createElement("span", { style: { display: "block", color: REF_MUTED, fontSize: 12.5, marginTop: 5, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.proc, " \xB7 ", a.dur)), /* @__PURE__ */ React.createElement("span", { style: { paddingRight: 13 } }, /* @__PURE__ */ React.createElement(RefStatusBadge, { status: a.status }))));
}
function RefBottomNav({ view, setView }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { position: "sticky", bottom: 0, padding: "10px 8px calc(12px + env(safe-area-inset-bottom,0px))", zIndex: 20 } }, /* @__PURE__ */ React.createElement(RefGlass, { style: { borderRadius: 28, padding: "7px 8px" } }, /* @__PURE__ */ React.createElement("span", { style: { display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: 4 } }, items.map(([key, label, icon]) => {
    const on = active === key;
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        key,
        onClick: () => key === "agenda" ? setView("agenda") : key === "home" ? setView("home") : null,
      ...
      /* @__PURE__ */ React.createElement(RefIcon, { type: icon, size: 26 }),
      label
    );
  }))), /* @__PURE__ */ React.createElement("div", { style: { width: 134, height: 5, borderRadius: 999, background: "rgba(255,255,255,.9)", margin: "10px auto 0" } }));
}
function RefDashboard({ setView }) {
  const kpis = [
    ...
    ["bars", "Tasa de ocupaci\xF3n", "89%", "\u2191 12% vs ayer"]
  ];
  const action = (icon, label, onClick, primary) => /* @__PURE__ */ React.createElement("button", { onClick, style: { border: 0, borderRadius: 17, background: "rgba(255,255,255,.055)", color: REF_TEXT, minHeight: 84, fontFamily: SF, fontSize: 14, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 8, boxShadow: "inset 0 0 0 1px rgba(255,255,255,.11)" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 44, height: 44, borderRadius: 16, display: "grid", placeItems: "center", background: primary ? "linear-gradient(135deg,#57A2FF,#255BE9)" : "transparent", color: "#fff", boxShadow: primary ? "0 16px 30px rgba(47,123,255,.35)" : "none" } }, /* @__PURE__ */ React.createElement(RefIcon, { type: icon, size: primary ? 29 : 32 })), label);
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "0 9px 0", display: "flex", flexDirection: "column", gap: 13 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 17, padding: "0 6px" } }, /* @__PURE__ */ React.createElement("img", { src: "/assets/jc-pro.jpg?v=1", alt: "", style: { width: 72, height: 72, borderRadius: "50%", objectFit: "cover", objectPosition: "50% 22%", border: "1px solid rgba(255,255,255,.34)", boxShadow: "0 12px 26px rgba(0,0,0,.25)" } }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 29, fontWeight: 750, color: REF_TEXT, letterSpacing: "-.04em" } }, "Hola, Dr. Mart\xEDnez"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 21, color: REF_MUTED, marginTop: 3 } }, "Viernes, 4 de julio"))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 9 } }, kpis.map(([icon, label, num, sub]) => /* @__PURE__ */ React.createElement(RefGlass, { key: label, style: { borderRadius: 17, height: 116, padding: "11px 4px 10px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("span", { style: { height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", { style: { color: "rgba(225,239,255,.86)" } }, /* @__PURE__ */ React.createElement(RefIcon, { type: icon, size: 22 })), /* @__PURE__ */ React.createElement("span", { style: { color: REF_TEXT, fontSize: 13, fontWeight: 650, minHeight: 28, display: "flex", alignItems: "center", justifyContent: "center", lineHeight: 1.1 } }, label), /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 35, fontWeight: 500, lineHeight: 1, letterSpacing: "-.04em" } }, num), /* @__PURE__ */ React.createElement("span", { style: { color: sub.indexOf("\u2191") === 0 ? "#7DDEA8" : REF_MUTED, fontSize: 11 } }, sub))))), /* @__PURE__ */ React.createElement(RefStatusBar, null), /* @__PURE__ */ React.createElement(RefGlass, { style: { borderRadius: 23, padding: 9 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10 } }, action("plus", "Nueva cita", () => setView("new"), true), action("users", "Pacientes"), action("clock", "Bloquear horario"), action("bars", "Reportes"))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", margin: "4px 3px 12px" } }, /* @__PURE__ */ React.createElement("h2", { style: { margin: 0, color: REF_TEXT, fontSize: 22, fontWeight: 750, letterSpacing: "-.03em" } }, "Pr\xF3ximas citas"), /* @__PURE__ */ React.createElement("button", { onClick: () => setView("agenda"), style: { border: "1px solid rgba(255,255,255,.18)", background: "rgba(255,255,255,.07)", color: "#fff", borderRadius: 12, padding: "9px 13px", fontFamily: SF, fontSize: 13, fontWeight: 700 } }, "Ver agenda \u203A")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10 } }, REF_APPTS.slice(0, 5).map((a) => /* @__PURE__ */ React.createElement(RefAppointmentRow, { key: a.time, a })))));
}
function RefAgenda({ setView }) {
  const dates = [["Vie", "4"], ["S\xE1b", "5"], ["Dom", "6"], ["Lun", "7"], ["Mar", "8"], ["Mi\xE9", "9"], ["Jue", "10"]];
  const yFor = (time) => {
    const [h, m] = time.split(":").map(Number);
    return (h - 8) * 64 + (m || 0) / 60 * 64;
  };
  return /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px 0", display: "flex", flexDirection: "column", gap: 17 } }, /* @__PURE__ */ React.createElement(RefGlass, { style: { borderRadius: 20, padding: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "grid", gridTemplateColumns: "1fr 1fr" } }, /* @__PURE__ */ React.createElement("button", { style: { border: 0, borderRadius: 18, height: 61, background: "linear-gradient(180deg,#3F8BFF,#215BDE)", color: "#fff", fontFamily: SF, fontSize: 19, fontWeight: 750 } }, "D\xEDa"), /* @__PURE__ */ React.createElement("button", { style: { border: 0, borderRadius: 18, height: 61, background: "transparent", color: REF_TEXT, fontFamily: SF, fontSize: 19 } }, "Mes"))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "44px repeat(7,1fr) 44px", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement("button", { style: { height: 43, border: 0, borderRadius: 12, background: "rgba(255,255,255,.08)", color: "#fff" } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "back", size: 26 })), dates.map(([d, n], i) => /* @__PURE__ */ React.createElement("button", { key: n, style: { height: 67, borderRadius: 13, border: "1px solid " + (i === 0 ? "rgba(99,159,255,.5)" : "rgba(255,255,255,.13)"), background: i === 0 ? "linear-gradient(180deg,#438EFF,#215CDE)" : "rgba(255,255,255,.055)", color: "#fff", fontFamily: SF } }, /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 13, opacity: 0.84 } }, d), /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 27, fontWeight: i === 0 ? 800 : 500, marginTop: 2 } }, n))), /* @__PURE__ */ React.createElement("button", { style: { height: 43, border: 0, borderRadius: 12, background: "rgba(255,255,255,.08)", color: "#fff", transform: "rotate(180deg)" } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "back", size: 26 }))), /* @__PURE__ */ React.createElement(RefStatusBar, null), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", height: 710, paddingBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", left: 84, top: 12, bottom: 28, width: 1, background: "rgba(255,255,255,.14)" } }), REF_HOURS.map((h, i) => /* @__PURE__ */ React.createElement("div", { key: h, style: { position: "absolute", left: 0, right: 0, top: 12 + i * 64, height: 1, background: "rgba(255,255,255,.08)" } }, /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 0, top: -12, color: REF_TEXT, fontSize: 18 } }, h), /* @__PURE__ */ React.createElement("span", { style: { position: "absolute", left: 78, top: -4, width: 9, height: 9, borderRadius: "50%", border: "1px solid rgba(255,255,255,.16)", background: "rgba(28,61,105,.85)" } }))), REF_APPTS.map((a) => /* @__PURE__ */ React.createElement(RefGlass, { key: a.time, style: { position: "absolute", left: 104, right: 0, top: Math.max(78, yFor(a.time) - 10), height: 73, borderRadius: 11, borderLeft: "3px solid " + RefStatusColor(a.status) } }, /* @__PURE__ */ React.createElement("span", { style: { height: "100%", display: "grid", gridTemplateColumns: "1fr auto", alignItems: "center", gap: 10, padding: "0 12px 0 20px" } }, /* @__PURE__ */ React.createElement("span", { style: { minWidth: 0 } }, /* @__PURE__ */ React.createElement("strong", { style: { display: "block", fontSize: 18, color: REF_TEXT, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.name), /* @__PURE__ */ React.createElement("span", { style: { display: "block", color: REF_MUTED, fontSize: 13, marginTop: 6, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, a.proc, " \xB7 ", a.dur)), /* @__PURE__ */ React.createElement(RefStatusBadge, { status: a.status })))), /* @__PURE__ */ React.createElement("button", { onClick: () => setView("new"), style: { position: "absolute", right: 0, bottom: 30, width: 86, height: 86, borderRadius: "50%", border: "1px solid rgba(255,255,255,.25)", background: "linear-gradient(180deg,#5AA9FF,#1E5BDF)", color: "#fff", boxShadow: "0 22px 44px rgba(0,0,0,.36), 0 0 26px rgba(47,123,255,.32)" } }, /* @__PURE__ */ React.createElement(RefIcon, { type: "plus", size: 48 }))));
}
function RefNewAppointment({ setView }) {
  const field = (icon, text, right) => /* @__PURE__ */ React.createElement(RefGlass, { style: { borderRadius: 13, height: 68 } }, /* @__PURE__ */ React.createElement("span", { style: { height: "100%", display: "flex", alignItems: "center", gap: 14, padding: "0 20px", color: REF_TEXT, fontSize: 19 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "rgba(230,242,255,.86)" } }, icon), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" } }, text), right || /* @__PURE__ */ React.createElement(RefIcon, { type: "chev", size: 22 })));
...
function MediqueEnterpriseMobile({ T }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: bg }, /* @__PURE__ */ React.createElement("div", { className: "jc-scroll", style: { width: "100%", maxWidth: 430, height: "100dvh", display: "flex", flexDirection: "column", background: "linear-gradient(180deg, rgba(16,54,101,.14), rgba(7,28,58,.34))", boxShadow: "0 0 80px rgba(0,0,0,.28)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "calc(10px + env(safe-area-inset-top,0px)) 10px 0" } }, /* @__PURE__ */ React.createElement(RefTopStatus, null), /* @__PURE__ */ React.createElement(RefHeader, { view, setView })), /* @__PURE__ */ React.createElement("main", { ref: mainRef, className: "jc-scroll", style: { flex: 1, paddingBottom: 8, overflowY: "auto", overflowX: "hidden" } }, view === "agenda" ? /* @__PURE__ */ React.createElement(RefAgenda, { setView }) : view === "new" ? /* @__PURE__ */ React.createElement(RefNewAppointment, { setView }) : /* @__PURE__ */ React.createElement(RefDashboard, { setView })), /* @__PURE__ */ React.createElement(RefBottomNav, { view, setView })));
}
